...
force force ace_medical_treatment_cprSuccessChanceMin = 0.2;
force force ace_medical_treatment_graveDiggingMarker = true;
force force ace_medical_treatment_holsterRequired = 0;
force force ace_medical_treatment_litterCleanupDelay = 10;
...
force force kat_airway_Larynxtubus_time = 6;
...
force force kat_airway_occlusion_repeatTimer = 180;
force force kat_airway_probability_headturning = 75;
force force kat_airway_probability_obstruction = 1;
force force kat_airway_probability_occluded = 1;
force force kat_airway_RecoveryPosition_Time = 6;
force force kat_airway_RecoveryPosition_TimeToDrain = 3;
...
force force kat_breathing_BVMOxygen_Multiplier = 3;
force force kat_breathing_clearChestSealAfterTreatment = false;
force force kat_breathing_deepPenetratingInjuryChance = 40;
force force kat_breathing_deterioratingPneumothorax_chance = 33;
force force kat_breathing_deterioratingPneumothorax_interval = 180;
...
force force kat_breathing_mildValue = 80;
...
force force kat_breathing_PulseOximeter_SpO2Warning = 80;
force force kat_breathing_severeValue = 75;
...
force force kat_breathing_SpO2_unconscious = 70;
force force kat_breathing_Stable_spo2 = 85;
force force kat_breathing_staminaLossAtLowSPO2 = false;
force force kat_breathing_stethoscopeListeningTime = 8;
...
force force kat_circulation_AED_MaxChance = 40;
force force kat_circulation_AED_MinChance = 20;
force force kat_circulation_AED_X_MaxChance = 90;
force force kat_circulation_AED_X_MinChance = 50;
force force kat_circulation_AED_X_Monitor_SpO2Warning = 80;
...
force force kat_circulation_DefibrillatorPads_AttachTime = 3;
...
force force kat_misc_AFAKFourthSlotItem = "[['kat_ncdKit', 4], ['kat_aatKit', 4]]";
force force kat_misc_AFAKSecondSlotItem = "[['SAB_medigel', 10], ['SAB_biofoam', 25], ['SAB_Large_Biofoam', 10]]";
force force kat_misc_AFAKSixthSlotItem = "[['ACE_morphine', 3], ['ACE_epinephrine', 3], ['ACE_adenosine', 3], ['ACE_plasmaIV_500', 2], ['SAB_StimPack', 3]]";
force force kat_misc_AFAKThirdSlotItem = "[['SAB_Motrin', 15], ['Ace_Painkiller', 1]]";
...
force force kat_misc_IFAKFourthSlotItem = "[['kat_ncdKit', 4], ['kat_aatKit', 4], ['plp_bo_inv_Lifebelt', 1]]";
force force kat_misc_IFAKSecondSlotItem = "[['21st_r_medigel', 1], ['21st_r_biofoam', 1]]";
force force kat_misc_IFAKThirdSlotItem = "[['21st_Copium', 15], ['ACE_morphine', 3], ['ACE_epinephrine', 3], ['ACE_adenosine', 3], ['ACE_plasmaIV_500', 4], ['kat_IV_16', 4]]";
...
force force kat_misc_MFAKEighthSlotItem = "[['ACE_surgicalKit', 1], ['kat_X_AED', 1], ['ACE_BodyBag_blue', 4], ['plp_bow_inv_BottleGin', 1], ['kat_Bubble_Wrap', 2]]";
force force kat_misc_MFAKFifthSlotItem = "[['kat_pocket_BVM', 1], ['kat_oxygenTank_300_Item', 1]]";
force force kat_misc_MFAKFirstSlotItem = "[['ACE_tourniquet', 8], ['ACE_splint', 6]]";
force force kat_misc_MFAKFourthSlotItem = "[['kat_aatKit', 10],, ['kat_stethoscope', 1]['kat_accuvac',1]";
force force kat_misc_MFAKSecondSlotItem = "[['21st_r_medigel', 1], ['21st_r_biofoam', 1]]";
force force kat_misc_MFAKSeventhSlotItem = "[['kat_EACA', 6], ['kat_TXA', 6], ['kat_fentanyl', 2], ['kat_norepinephrine', 6], ['kat_ketamine', 4], ['21st_Copium', 40], ['kat_naloxone', 6], ['kat_phenylephrine', 6], ['ACE_epinephrine', 6], ['ACE_adenosine', 6], ['kat_Carbonate', 2]";
force force kat_misc_MFAKSixthSlotItem = "[['ACE_plasmaIV_500', 10], ['ACE_plasmaIV', 15], ['kat_IV_16', 20], ['kat_IO_FAST', 6]]";
force force kat_misc_MFAKThirdSlotItem = "[['kat_aatKit', 6], [[['kat_larynx', 8], ['kat_guedel', 6], [kat_accuvac', 1]]";
force force kat_misc_tourniquetEffects_Enable = false;
force force kat_misc_tourniquetEffects_NegativeMultiplier = 1;
force force kat_misc_tourniquetEffects_PositiveMultiplier = 1.5;
...
force force kat_pharma_CheckCoag_MedLevel = 0;
...
force force kat_pharma_medLvl_EpinephrineIV = 0;
...
force force kat_pharma_pervitinSpeed = 1.25;
...
force force kat_pharma_treatmentTime_Amiodarone = 5;
force force kat_pharma_treatmentTime_ApplyIO = 3;
force force kat_pharma_treatmentTime_ApplyIV = 5;
force force kat_pharma_treatmentTime_Atropine = 5;
force force kat_pharma_treatmentTime_Carbonate = 5;
force force kat_pharma_treatmentTime_EACA = 5;
force force kat_pharma_treatmentTime_EpinephrineIV = 7;
force force kat_pharma_treatmentTime_Etomidate = 2;
force force kat_pharma_treatmentTime_Fentanyl = 5;
force force kat_pharma_treatmentTime_Flumazenil = 2;
force force kat_pharma_treatmentTime_Ketamine = 5;
force force kat_pharma_treatmentTime_Lidocaine = 5;
force force kat_pharma_treatmentTime_Lorazepam = 2;
force force kat_pharma_treatmentTime_Nalbuphine = 5;
force force kat_pharma_treatmentTime_Naloxone = 5;
force force kat_pharma_treatmentTime_Nitroglycerin = 5;
force force kat_pharma_treatmentTime_Norepinephrine = 5;
force force kat_pharma_treatmentTime_Penthrox = 8;
force force kat_pharma_treatmentTime_Pervitin = 5;
force force kat_pharma_treatmentTime_Phenylephrine = 5;
