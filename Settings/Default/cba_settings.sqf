// 1st MEU Aux Mod
force DBA_Hyperspace_Offset_Default = 180;
force MEU_Bubble_Deploy_Time = 5;
force MEU_Bubble_Duration = 240;
force MEU_Chromeman_Enable_Death = true;
force MEU_Common_Debug = false;
force MEU_DeployableShield_Duration = 180;
force MEU_DeployableShield_Time = 3;
force MEU_Elite_Armor_FieldMarshal_shield_modifier = 28.25;
force MEU_Elite_Armor_HonorGuard_shield_modifier = 32.4;
force MEU_Elite_Armor_HonorGuard_Ultra_shield_modifier = 36.45;
force MEU_Elite_Armor_Major_shield_modifier = 8.1;
force MEU_Elite_Armor_Minor_shield_modifier = 3.8;
force MEU_Elite_Armor_SpecOps_shield_modifier = 2;
force MEU_Elite_Armor_Ultra_shield_modifier = 12.15;
force MEU_Elite_Armor_Zealot_shield_modifier = 24.3;
MEU_EX_Afterburner_Enable = true;
force MEU_Extra_Shielded_Armors = "example_class_name,1.234";
force MEU_Frigate_Launch_Delay = 30;
force MEU_Frigate_Move_Duration = 60;
force MEU_Frigate_Turn_Duration = 15;
force MEU_Frigate_Vehicles = "MEU_M914_RV, MEU_M813_TT,MEU_M12R_AA, MEU_M12G1_LRV, MEU_M12A1_LRV, MEU_M12_LRV, MEU_M12_FAV, MEU_M12_FAV_APC, MEU_M12_FAV_APC_MED, 1stMEU_M313_Lockdown, 1st_meu_vulcan_repair_vic,MEU_M412_IFV_UNSC,MEU_Leopard_APC,MEU_IFV_A,MEU_SCORPION,MEU_M808B2,1st_meu_oryx";
force MEU_Grunt_AI_Flee_Chance = 0.25;
force MEU_Grunt_AI_Grenade_Charge_Chance = 0.25;
force MEU_HEV_Allow_Jellybean = true;
force MEU_HEV_Atmosphere_End = "2000";
force MEU_HEV_Atmosphere_Start = "3000";
force MEU_HEV_Chute_Detach = "500,200,100";
force MEU_HEV_Chute_Open = "1000,500,300";
force MEU_HEV_Chute_Velocity = 0;
force MEU_HEV_Debug_Arrow = false;
force MEU_HEV_Eject_Delay = 0;
force MEU_HEV_Eject_Distance = 3;
force MEU_HEV_Explosion_Class = "MEU_HEV_Landing_Explosive";
force MEU_HEV_Explosion_Enabled = false;
force MEU_HEV_Explosion_Simulation_Delay = 0.5;
force MEU_HEV_Invincible_On_Landing = true;
force MEU_HEV_Jellybean_Forward = 10;
force MEU_HEV_Jellybean_Up = 15;
force MEU_HEV_Jellybean_Use = 4;
force MEU_HEV_Landed_Altitude = 3;
force MEU_HEV_Start_Heights = "5000,4500,4000";
force MEU_HEV_Thruster_Limit = false;
force MEU_HEV_Thruster_Max_Velocity = 20;
force MEU_HEV_Thruster_Min_Height = 500;
force MEU_HEV_Thruster_Rotate_Angle = 45;
force MEU_HEV_Thruster_Rotate_Time = 0.5;
force MEU_HEV_Thruster_Uses = 5;
force MEU_HEV_Thruster_Velocity = 5;
MEU_LEO_FFF_enableMod = true;
MEU_LEO_FFF_minHeight = 100;
force MEU_POGV_Deploy_Altitude = 50;
force MEU_Rotate_Step = 30;
force MEU_Slipspace_Offset_CCS_Battle_Cruiser = 180;
force MEU_Slipspace_Offset_Default = 180;
force MEU_Slipspace_Offset_Frigate = 180;
...
// ACE Explosives
ace_explosives_customTimerDefault = 20;
...
// ACE G-Forces
force ace_gforces_coef = 0.099027;
...
force ace_hearing_unconsciousnessVolume = 0.35;
...
ace_interact_menu_moveToRoot__ACE_Equipment__1st_meu_deploy_pogv = false;
ace_interact_menu_moveToRoot__ACE_Equipment__1st_meu_use_chrome_spray = false;
...
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_deleteProfile = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_exportProfile = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadAll = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadFromLRToLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadFromLRToVLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadFromSRAndFromLRToLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadFromVLRToLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_loadBase__tfar_ace_extended_main_loadFromVLRToVLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_newProfile = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_resetCrewStatus = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveAll = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveFromLRtoLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveFromLRtoVLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveFromVLRtoLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveFromVLRtoVLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_saveBase__tfar_ace_extended_main_saveSRAndFromLRtoLR = false;
ace_interact_menu_moveToRoot__TFAR_Radio__tfar_ace_extended_main__tfar_ace_extended_main_setCrewStatus = false;
...
force ace_medical_bleedingCoefficient = 0.9;
...
force ace_medical_ivFlowRate = 4.2;
...
force ace_medical_treatment_convertItems = 2;
...
force force ace_nametags_playerNamesMaxAlpha = 0.798915;
...
force aceP_circulation_IOestablish = 3;
force aceP_circulation_IVdrop = 600;
force aceP_circulation_IVdropEnable = true;
force aceP_circulation_IVestablish = 3;
force aceP_circulation_IVmedic = 0;
force aceP_circulation_IVreuse = true;
...
force ace_overpressure_distanceCoefficient = 0.5;
...
// Covenant Shielded Armors
force MEU_SANGHEILI_POWERED_SUITS_SETTING = "MEU_Elite_Armor_SpecOps,MEU_Elite_Armor_Minor,MEU_Elite_Armor_Major,MEU_Elite_Armor_Ultra,MEU_Elite_Armor_Zealot,MEU_Elite_Armor_FieldMarshal,MEU_Elite_Armor_HonorGuard,MEU_Elite_Armor_HonorGuard_Ultra";
...
// LAMBS Danger
force lambs_danger_cqbRange = 40;
...
force lambs_main_minSuppressionRange = 70;
...
force OPTRE_MJOLNIR_SHIELD_ENERGY = 150;
...
force OPTRE_Hijack_Mode = 1;

// Precursors - Carrier Form
dev_flood_carrier_agroDistance = 1000;
dev_flood_carrier_distance_roam = 75;
dev_flood_carrier_explodeDistance = 10;
dev_flood_carrier_health = 0.05;
dev_flood_carrier_huntDistance = 1500;
dev_flood_carrier_maxDistance = 2000;
dev_flood_carrier_maxInfections = 6;

// Precursors - Combat Form
dev_flood_combat_attack_damageMan = 0.5;
dev_flood_combat_attack_damageVeh = 0.1;
dev_flood_combat_attack_launchChance = 0.01;
dev_flood_combat_attack_launchMan = "[0,6,5]";
dev_flood_combat_attack_launchVeh = "[0,1,1]";
dev_flood_combat_attack_reachMan = 3.5;
dev_flood_combat_attack_reachVeh = 8;
dev_flood_combat_attack_timeout = 0.3;
dev_flood_combat_distance_agro = 250;
dev_flood_combat_drop_chance = 0.5;
dev_flood_combat_health = 1.7;
dev_flood_combat_jump_chance = 0.35;
dev_flood_combat_jump_timeout = 30;

// Precursors - Infection Form
dev_flood_infection_agroDistance = 1000;
dev_flood_infection_attack2Timeout = 4;
dev_flood_infection_attack3Timeout = 20;
dev_flood_infection_attackDistanceMan = 3.5;
dev_flood_infection_attackDistanceVeh = 7;
dev_flood_infection_attackTimeout = 1;
dev_flood_infection_damageMan = 0.2;
dev_flood_infection_damageManAttack2 = 0.2;
dev_flood_infection_damageManAttack3 = 0.25;
dev_flood_infection_damageVeh = 0.001;
dev_flood_infection_distance_roam = 75;
dev_flood_infection_health = 0.05;
dev_flood_infection_huntDistance = 1500;
dev_flood_infection_jumpTimeout = 20;
dev_flood_infection_maxDistance = 2000;
dev_flood_infection_specialChance = 0.1;
...
tfar_ace_extended_main_airProfile = "None";
tfar_ace_extended_main_askDeleteConfirmation = true;
tfar_ace_extended_main_askLoadConfirmation = true;
tfar_ace_extended_main_askOverwriteConfirmation = true;
tfar_ace_extended_main_askSaveConfirmation = true;
tfar_ace_extended_main_crewStatusDefault = false;
tfar_ace_extended_main_enableAllInteractions = true;
tfar_ace_extended_main_enableArsenalAutoSettings = true;
tfar_ace_extended_main_enableCompatFK = true;
tfar_ace_extended_main_enableLRInteractions = true;
tfar_ace_extended_main_enableMountingAutoSettings = true;
tfar_ace_extended_main_enableSRAndLRInteractions = true;
tfar_ace_extended_main_enableSRInteractions = true;
tfar_ace_extended_main_enableVLRInteractions = true;
tfar_ace_extended_main_landProfile = "None";
tfar_ace_extended_main_loadColorIcon = [1,1,1];
...
force tsp_cba_breach_ammo = "[""B_12Gauge_Slug_NoCartridge"", ""OPTRE_12Rnd_8Gauge_Slugs"",""OPTRE_6Rnd_8Gauge_Slugs"",""rhs_ammo_12g_slug"", ""rhs_ammo_12g_00buckshot""]";
force tsp_cba_breach_ammoMultiplier = 1;
force tsp_cba_breach_autoTime = 4;
...
zen_editor_randomizeCopyPaste = true;
...
zen_faction_filter_0_TCF_Frieden_Des = true;
zen_faction_filter_0_TCF_Frieden_Wdl = true;
zen_faction_filter_0_TCF_Frieden_Win = true;
zen_faction_filter_0_TCF_Frieden_WINPAT = true;
zen_faction_filter_0_TCF_GMF = true;
zen_faction_filter_0_TCF_Koslovic_Ard = true;
zen_faction_filter_0_TCF_Koslovic_des = true;
zen_faction_filter_0_TCF_Koslovic_Jun = true;
zen_faction_filter_0_TCF_Koslovic_Swa = true;
zen_faction_filter_0_TCF_Koslovic_Urb = true;
zen_faction_filter_0_TCF_Koslovic_Wdl = true;
zen_faction_filter_0_TCF_Koslovic_Win = true;
zen_faction_filter_0_TCF_SU = true;
zen_faction_filter_0_TCF_URA = true;
zen_faction_filter_0_TCF_URA_D = true;
zen_faction_filter_0_TCF_URA_urb = true;
...
zen_faction_filter_1_B_19thUNSC_Urban = true;
...
zen_faction_filter_1_MEU_UNSC = true;
zen_faction_filter_1_OPTRE_UNSC = true;
zen_faction_filter_1_TCF_HCM = true;
